...
import fullPosterFrameSrc from "../../images/full.png";
import nFullPosterFrameSrc from "../../images/n-full.png";
...
export default function AddressForm() {
  ...
  const handleSubmit = () => {
    ...
    context.drawImage(cropCanvasRef.current, 400, 570, 475, 475);
    context.drawImage(posterFrameImageRef.current, 0, 0);

    context.font = "60px TimesNewRoman";
    context.textAlign = "center";
    context.fillStyle = "#ffffff";
    context.fillText(fullName.toUpperCase(), 640, 1150);
    ...
    <React.Fragment>
      {isLoading ? (
        ...
        <React.Fragment>
          ...
          />
          <img
            src={grade === "10" ? fullPosterFrameSrc : nFullPosterFrameSrc}
            alt="poster frame"
